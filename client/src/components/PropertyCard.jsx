...
const PropertyCard = ({ property }) => {
  ...
  const quoteHandler = () => {
    ...
    emailjs
      .send(
        String(import.meta.env.VITE_EMAILJS_SERVICE_NAME),
        String(import.meta.env.VITE_EMAILJS_TEMPLATE_NAME),
        templateParams,
  ...
  return (
    <>
      <div
        ...
        className="w-full aspect-3/4 bg-primary/10 flex flex-col items-center justify-center cursor-pointer hover:bg-primary/20 rounded-xl p-6 gap-3"
      >
            ...
            <div className="flex flex-col items-center gap-4 p-3 sm:p-5 h-full">
              ...
              <div className="flex gap-1 w-full">
                ...
                <div className="grid grid-cols-2 gap-1 p-2 text-nowrap rounded-xl bg-primary/20 w-3/4">
                  ...
                  <div className="gap-1 flex items-start justify-start">
                    Area:{" "}
                    <span className="font-bold">{property.area} Yards</span>
                  </div>
